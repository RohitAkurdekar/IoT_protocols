 ...
 * Batch: DIoT
 * Description: This program maintains two socket currently; you can add support 
 * for more sockets; Two clients instances can together chat using UI
 *-------------------------------------*/
...
server.on('upgrade',(request,socket, head)=>{
    ...
    if(pathname=="/tic/tac/toe") {      // aao/gappe/mare
